...
public:
	...
	BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
		...
		SHADER_PARAMETER_RDG_TEXTURE(Texture2D, TiledCoverageMap)
		SHADER_PARAMETER_SAMPLER(SamplerState, TiledCoverageMapSampler)
		SHADER_PARAMETER(uint32, bHasTiledCoverageMap)
		SHADER_PARAMETER_RDG_TEXTURE(TextureCube, CloudGlobalCoverageMap)
		SHADER_PARAMETER_SAMPLER(SamplerState, CloudGlobalCoverageMapSampler)
